...
export const kaiChangBaiMoBan: Record<MBTILeiXing, string[]> = {
  ISTJ: ['嗨，{mingZi}，不太擅长开场，但想认真认识你。'],
  ISFJ: ['你好呀{mingZi}，希望没有打扰到你~'],
  INFJ: ['嗨{mingZi}，不知道怎么开场，但觉得可以聊聊看。'],
  INTJ: ['你好，{mingZi}。直接一点，我想认识你。'],
  ISTP: ['嘿{mingZi}，随便聊聊？'],
  ISFP: ['嗨{mingZi}，今天天气不错？'],
  INFP: ['你好呀{mingZi}，希望我们能聊得来~'],
  INTP: ['{mingZi}你好，请问你对什么话题比较感兴趣？'],
  ESTP: ['哈喽{mingZi}！看你挺有意思的，认识一下？'],
  ESFP: ['嗨嗨{mingZi}！今天过得怎么样？'],
  ENFP: ['哈喽{mingZi}！终于等到你啦，超开心！'],
  ENFJ: ['你好{mingZi}，很高兴认识你，希望我们能聊得开心~'],
  ENTJ: ['{mingZi}你好，我时间有限，但对你有兴趣。'],
  ESTJ: ['你好{mingZi}，直接开始吧。'],
  ESFJ: ['嗨{mingZi}~最近怎么样呀？'],
  ENTP: ['哟{mingZi}，总算匹配到一个看起来不无聊的人了。'],
}
